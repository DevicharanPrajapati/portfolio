...
const Footer = () => {
  ...
  return (
    <footer className="block md:flex justify-between items-center h-auto w-full gap-20 px-4">
        <div>
            <Logo />
            <p className="mt-4 text-md">I am a frontend developer who loves <br />building clean, responsive, and user-friendly websites. <br />I focus on simple design and smooth user experience.</p>
        </div>
