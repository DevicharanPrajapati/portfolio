    ...
    <div className="min-h-100 card w-80 p-4 flex justify-between flex-col gap-3 border-2 rounded-2xl hover:shadow-xl shadow-gray-400 transition-all ease-in-out">
      ...
      <div className="buttons flex justify-between">
        <a
          ...
          className="p-2 border-2 px-4 rounded-b-lg hover:text-slate-600 font-exo font-bold flex justify-center items-center gap-1"
        >
          GitHub
          <FaGithub />
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 border-2 px-4 rounded-b-lg hover:text-red-600 font-exo font-bold flex justify-center items-center gap-1"
        >
          Live
          <MdLiveTv />
        </a>
